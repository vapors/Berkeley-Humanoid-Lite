...
ENV = ROOT / "berkeley_humanoid_lite/tasks/locomotion/velocity/config/lilgreen_humanoid/env_cfg_hardware_st3215_loaded_v145.py"
REW = ROOT / "berkeley_humanoid_lite/tasks/locomotion/velocity/mdp/rewards.py"
CURR = ROOT / "berkeley_humanoid_lite/tasks/locomotion/velocity/mdp/curriculums.py"
INIT = ROOT / "berkeley_humanoid_lite/tasks/locomotion/velocity/config/lilgreen_humanoid/__init__.py"
PPO = ROOT / "berkeley_humanoid_lite/tasks/locomotion/velocity/config/lilgreen_humanoid/agents/rsl_rl_ppo_cfg.py"
