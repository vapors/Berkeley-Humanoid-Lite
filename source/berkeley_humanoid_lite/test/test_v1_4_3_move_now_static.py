...
CFG = ROOT / "berkeley_humanoid_lite/tasks/locomotion/velocity/config/lilgreen_humanoid/env_cfg_hardware_st3215_loaded_v143.py"
CURR = ROOT / "berkeley_humanoid_lite/tasks/locomotion/velocity/mdp/curriculums.py"
REG = ROOT / "berkeley_humanoid_lite/tasks/locomotion/velocity/config/lilgreen_humanoid/__init__.py"
AGENT = ROOT / "berkeley_humanoid_lite/tasks/locomotion/velocity/config/lilgreen_humanoid/agents/rsl_rl_ppo_cfg.py"
REWARDS = ROOT / "berkeley_humanoid_lite/tasks/locomotion/velocity/mdp/rewards.py"
DIAG = ROOT / "berkeley_humanoid_lite/tasks/locomotion/velocity/mdp/diagnostics.py"
