...
from berkeley_humanoid_lite_assets.robots.lilgreen_humanoid import LILGREEN_CFG, LILGREEN_JOINTS
...
class RewardsCfg:
    ...
    undesired_contacts = RewTerm(
        ...
        params={
            ...
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=["base", ".*_hip_.*", ".*_knee_.*"]),"threshold": 1.0,
        },
    )
