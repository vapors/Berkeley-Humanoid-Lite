...
def moving_no_progress_timeout(
    ...
    active_timer = getattr(env, "_bhl_v146_moving_active_timer_s", None)
    stall_timer = getattr(env, "_bhl_v146_no_progress_timer_s", None)
    ...
    env._bhl_v146_moving_active_timer_s = active_timer
    env._bhl_v146_no_progress_timer_s = stall_timer
    return done
...
def moving_no_support_timeout(
    ...
    timer = getattr(env, "_bhl_v147_no_support_timer_s", None)
    ...
    env._bhl_v147_no_support_timer_s = timer
